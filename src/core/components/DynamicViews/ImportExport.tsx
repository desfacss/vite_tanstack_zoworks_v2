                    ...
                    const records = result.data
                        ...
                        .map(async (row) => {
                            ...
                            for (const [displayName, value] of Object.entries(row)) {
                                ...
                                if (foreignKeyMaps[columnName]) {
                                    finalValue = value ? await convertDisplayToId(foreignKeyMaps[columnName].source_table, foreignKeyMaps[columnName].source_column, foreignKeyMaps[columnName].display_column, String(value)) : null;
                                }
