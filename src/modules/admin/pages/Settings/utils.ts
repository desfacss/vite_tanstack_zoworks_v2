class Utils {
	 ...
	 */
	static antdTableSorter(a: any, b: any, key: string): number | undefined {
	 ...
	 */
	static filterArray(list: any[], key: string, value: any): any[] {
		let data = list;
		if (list) {
	 ...
	 */
	static deleteArrayRow(list: any[], key: string, value: any): any[] {
		let data = list;
		if (list) {
			data = list.filter(item => item[key] !== value);
		}
	 ...
	 */
	static wildCardSearch(list: any[], input: string | number): any[] {
	 ...
	 */
	static getBreakPoint(screens: Record<string, boolean>): string[] {
