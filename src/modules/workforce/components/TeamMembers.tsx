    ...
    return (
        <Spin spinning={isLoading}>
            <div className="flex flex-col h-full space-y-4">
                ...
                <Card size="small" title={<><Users size={16} className="inline mr-2" /> {t('common.team_members')}</>}>
                    <List
                        size="small"
                        bordered
                ...
                <Card size="small" title={<><User size={16} className="inline mr-2" /> {t('teams.add_members')}</>}>
                    <List
                        size="small"
                        bordered
