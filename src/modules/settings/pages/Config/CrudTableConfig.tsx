...
const transformSchemaToFields = (schema: any) => {
    console.log("sc", schema)
    if (!schema || !schema.properties) return [];
    return Object.entries(schema.properties).map(([fieldName, fieldData]: [string, any], index) => ({
        sequence: index + 1,
...
interface CrudTableConfigProps {
    jsonSchema: any;
    onSave: (data: any[]) => void;
}

const CrudTableConfig: React.FC<CrudTableConfigProps> = ({ jsonSchema, onSave }) => {
